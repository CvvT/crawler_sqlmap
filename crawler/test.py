...
if __name__ == '__main__':
    response = request.urlopen("http://demo.aisec.cn/demo/aisec/")
    page = response.read()
    page = BeautifulSoup(page, "html.parser")
    for form in page.find_all('form'):
        print(urljoin("http://demo.aisec.cn/demo/aisec/", form.get('action')),
              form.get('method', 'get'), extract_form_fields(form))
